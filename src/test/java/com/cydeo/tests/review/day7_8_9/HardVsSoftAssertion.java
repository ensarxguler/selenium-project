...
public class HardVsSoftAssertion extends TestBase {
    ...
    @Test
    public void web_table_practice1() {
    ...
    @Test
    public void web_table_practice2() {
        ...
        // 4. Verify "tconway@earthlink.net" is anywhere in the table USING SOFT ASSERTION.
        SoftAssert softAssert = new SoftAssert();
        
        softAssert.assertTrue(tableData.contains("tconway@earthlink.net..."));
        ...
        // 7. Verify Tim due amount is "$50.00"
        softAssert.assertEquals(driver.findElement(By.xpath("//table[@id='table1']//td[.='Tim']/following-sibling::td[2]")).getText(), "$50.00.");
        
        // We have to use the .assertAll() method to get the "ASSERTION REPORT".
